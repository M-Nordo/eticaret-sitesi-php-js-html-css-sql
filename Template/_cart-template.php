...
<section id="cart" class="py-3 mb-5">
    <div class="container-fluid w-75">
        <h5 class="font-baloo font-size-20">Sepet</h5>
        ...
        <div class="row">
                ...
                <div class="row border-top py-3 mt-3">
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="d-flex">
                            ...
                            <a href="#" class="px-2 font-rale font-size-14">20,534 oylama</a>
                        </div>
                        <!--  !product rating-->
                        ...
                        <div class="qty d-flex pt-2">
                            ...
                            <form method="post">
                                <input type="hidden" value="<?php echo $item['item_id'] ?? 0; ?>" name="item_id">
                                <button type="submit" name="wishlist-submit" class="btn font-baloo text-danger">Kaydet</button>
                            </form>
            ...
            <div class="col-sm-3">
                <div class="sub-total border text-center mt-2">
                    <h6 class="font-size-12 font-rale text-success py-3"><i class="fas fa-check"></i> Kargonuz bizden...</h6>
                    <div class="border-top py-4">
                        ...
                        <button type="submit" class="btn btn-warning mt-3">Tıkla ve Satın Al</button>
                    </div>
                </div>
            </div>
            <!-- !subtotal section-->
